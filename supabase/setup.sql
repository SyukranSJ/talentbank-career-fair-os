...
--   0002_grants.sql     database permissions
--   0003_multi_day.sql  multi-day events + audience restrictions
--
-- The Supabase SQL Editor runs this as a single transaction, so it either
-- applies completely or not at all. Safe to run more than once.
--
-- Generated from the files in supabase/migrations/ — do not edit by hand;
